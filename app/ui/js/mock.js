  ...
  switch (cmd) {
    ...
    case "provider_fetch_release":
      ...
      return Promise.resolve({
        ...
        // format quantity.
        // Each disc under its own heading, so the browser path exercises the
        // tracklist sub-sections (#328); the section labels come off Discogs
        // `heading` rows the provider now preserves.
        tracks: [
          { position: "1-1", disc: 1, section: "CD1 — Temple Of House", artist: "The X Factor", title: "Desert Rain", duration_secs: 278 },
          { position: "1-2", disc: 1, section: "CD1 — Temple Of House", artist: "Wish Mountain", title: "Radio", duration_secs: 142 },
          { position: "2-1", disc: 2, section: "CD2 — The Vinyl Sessions", artist: "West Coast Connection", title: "Voodoo Rhythm", duration_secs: 321 },
        ],
        disc_total: 2,
